...
class BodyFormat(str, Enum):
    # HTML representation for viewing, but with absolute urls,
    # instead of relative urls in the markup
    HTML = "HTML"
    # Storage representation for editing, with relative urls in the markup
    STORAGE = "storage"
