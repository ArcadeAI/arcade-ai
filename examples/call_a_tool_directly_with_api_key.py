...
def call_an_api_key_tool(client: Arcade, user_id: str) -> None:
    ...
    In this example, we are
        ...
        3. Printing the output of the tool's execution, i.e., a URL to a screenshot of the page at https://docs.arcade.dev/home
    ...
    # Execute the tool
    response = client.tools.execute(  # Ensure you have added your FIRECRAWL_API_KEY
